...
/*	* @Theme Name	:	BusiProf
	...
	* @author       :	Hari Maliya
	* @license      :	license.txt
	* @filesource   :	wp-content/themes/Busiprof/portfolio-2-column.php
*/
get_header ();
	...
	<div style="margin:0 10px 0;"><div class="container">
		<div class="portfolio_tab">
				<h2><?php if( $current_options['protfolio_tag_line']!='')
					...
					{ echo $current_options['protfolio_description_tag'];  } else {?><?php _e('Display Portfolio in a Responsive Two Column Layout','busi_prof');  } ?> </span></h2>
		</div>
		<div class="row">
		<?php 	global $paged;
				$j = 1;
			...
			<div class="pagination_blog">	
					<ul><li class="paginanext"><a href="#"><?php _e('Prev','busi_prof');?></a></li>
						<li><a href="#">1</a></li>
						<li><a href="#">2</a></li>
						<li><a href="#">3</a></li>
						<li><a href="#">4</a></li>
