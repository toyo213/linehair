...
/*	* @Theme Name	:	BusiProf
	...
	* @author       :	Hari Maliya
	* @license      :	license.txt
	* @filesource   :	wp-content/themes/Busiprof/portfolio-3-column.php
*/
get_header ();
	...
	<div style="margin:0 10px 0;"><div class="container">
		<div class="portfolio_tab">
				<h2><?php if( $current_options['protfolio_tag_line']!='')
					...
					{ echo $current_options['protfolio_description_tag'];  } else {?><?php _e('Display Portfolio in a Responsive Three Column Layout','busi_prof');  } ?> </span></h2>
		</div>
		<div class="row">
		<?php 	global $paged;
				$j=1;
				...
				//$args = array( 'post_type' => 'busiprof_portfolio','posts_per_page' =>6,) ; 	
				$portfolio = new WP_Query( $args );
				//$post_type_data = new WP_Query( $args );
				if( $portfolio->have_posts() )
				{	while ( $portfolio->have_posts() ) : $portfolio->the_post();
				?>	<div class="span4 port_cols_mn">
					...
					$count_posts_3c = wp_count_posts('busiprof_portfolio')->publish;
						if($count_posts_3c > 6) {
