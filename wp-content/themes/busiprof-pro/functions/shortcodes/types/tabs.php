    ...
    <table class="table table-bordered table-condensed">
		<tbody>
			<tr> <td>&nbsp;</td><td class="lable-all">Select Setting </td> </tr>
			    <tr><td class="lable-all" >Select Style</td>
					<td class="lable-all">
				...
				<tr><td class="lable-all" >New Tab Group?<br/ ><small>Select yes if this is the first tab in the set.</small></td>
                    <td class="lable-all"> 
				...
				<tr><td class="lable-all">Tab Title</td><td><input class="input-medium" placeholder="home" type="text" id="tabs_title" value="" name="tabs_title"></td></tr>
				...
				<tr><td>&nbsp;</td>
					<td>
					<a href="javascript:TabsDialog.insert(TabsDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Insert</a></td>
				</tr>
		</tbody>
	</table>    
</form>